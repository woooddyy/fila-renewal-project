...
<html lang="ko">
 <head>
  ...
  <style>
	...
	/*########## container ##########*/
		#container{width:100%; padding:50px 0; background-color:#f9f9f9;}
		#board{width:400px; margin:0 auto; background-color:#fff; box-shadow:3px 3px 10px rgba(0,0,0,.3); padding:20px 40px;}
		#board h3{text-align:center; padding-bottom:20px;}
		#board form{font-size:13px; width:100%;}
		#board form fieldset{border:none;}
		#board form legend{position:absolute; left:-9999px; width:1px; height:1px; line-height:0; font-size:1px; overflow:hidden;}
		#board form p{padding:10px 0; margin-bottom:20px;}
		#board form label{display:block; float:left; width:80px; text-align:center; line-height:25px;}
		#board form input:not(.button){width:280px; height:25px; text-indent:10px;}
		...
		#buttonArea input:hover{cursor:pointer; background-color:#CC393C; color:#fff;}
	...
	/*################################ 반응형 맞추기 #######################################*/
		...
		@media all and (min-width:480px) and (max-width:767px){
			...
			#board{width:400px; padding:15px 30px;}
		...
		@media all and (min-width:320px) and (max-width:479px){
			...
			#board{width:260px; padding:20px;}
			#board form label{text-align:left;}
			#board form input:not(.button){width:258px;}
...
<?php } ?>
		...
		<div id="container">
			...
			<section id="board">
				<h3>Q &amp; A</h3>
				<form action="fila_qna_delete_control.php?no=<?=$row['no']?>" method="post">
					<fieldset>
						<legend>문의게시판 삭제</legend>
						<p class="userpw">

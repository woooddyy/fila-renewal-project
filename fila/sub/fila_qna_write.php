 ...
 <head>
  ...
  <style>
	...
	/*########## container ##########*/
		...
		#board form fieldset{border:none; width:100%;}
		...
		#board form input:not(.button){height:23px; text-indent:10px; border:1px solid #aaa;}
		#board form .username{width:70%; float:left;}
		#board form .userpw{width:30%; float:left;}
		#board form input[id="title"]{width:898px;}
		#board form input[id="userpw"]{width:198px;}
		#board form .content{margin-top:20px;}
		#board form textarea{width:100%; height:300px; text-indent:10px; padding:10px 0; border:none;
		...
		#buttonArea .button{padding:5px 20px; background-color:#fff; border:1px solid #aaa;}
		#buttonArea .button:hover, #buttonArea a:focus{cursor:pointer; background-color:#CC393C; color:#fff;}
	...
	/*################################ 반응형 맞추기 #######################################*/
		...
		@media all and (min-width:768px) and (max-width:1024px){
			...
			#board form .username{width:60%;}
			#board form .userpw{width:40%;}
			#board form input[id="title"]{width:666px;}
			#board form input[id="userpw"]{width:217px;}
		...
		@media all and (min-width:480px) and (max-width:767px){
			...
			#board form .userpw{width:50%;}
			#board form input[id="title"]{width:378px;}
			#board form input[id="username"]{width:130px;}
			#board form input[id="userpw"]{width:158px;}
		...
		@media all and (min-width:320px) and (max-width:479px){
			...
			#board form input[id="username"]{width:130px;}
			#board form input[id="userpw"]{width:148px;}
...
<?php } ?>
		...
		<div id="container">
			...
			<section id="board">
				<h3>Q &amp; A 작성하기</h3>
				<form action="fila_qna_write_control.php" method="post">
					<fieldset>
						<legend>문의게시판 쓰기</legend>
						<div>
							<p>
								<label for="title">제목</label><input id="title" name="title" type="text" required autocomplete="off"/>
							</p>
							<p class="username">
								<label for="username">이름</label><input id="username" name="username" type="text" required autocomplete="off"/>
							</p>
							<p class="userpw">
								<label for="userpw">비밀번호</label><input id="userpw" name="userpw" type="password" required autocomplete="off" placeholder="10자까지 작성" maxlength="10"/>
							</p>
						</div>
						<p class="content">
							<label for="content">내용</label>
<textarea id="content" name="content" required placeholder="내용을 작성하세요...">
</textarea>
						</p>
						<p id="buttonArea">
							<input class="button" type="submit" value="저장" title="저장"/>
							<input class="button" type="reset" value="다시쓰기" title="다시쓰기"/>
							<a class="button" href="./fila_qna.php" title="목록">목록</a>
						</p>
					</fieldset>
				</form>
			</section>

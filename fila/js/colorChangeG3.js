$(document).ready(function(){
	...
	for(i=0;i<detail.length;i++){
		thumbImg0[i]="../img/buyProductG3_P_thumb"+i+".jpg";
	}
	for(i=0;i<detail.length;i++){
		thumbImg1[i]="../img/buyProductG3_W_thumb"+i+".jpg";
	}
	for(i=0;i<detail.length;i++){
		thumbImg2[i]="../img/buyProductG3_Bk_thumb"+i+".jpg";
	}
	pink.click(function(){

$(document).ready(function(){
	...
	for(i=0;i<detail.length;i++){
		thumbImg0[i]="../img/buyProductB1_Bk_thumb"+i+".jpg";
	}
	for(i=0;i<detail.length;i++){
		thumbImg1[i]="../img/buyProductB1_W_thumb"+i+".jpg";
	}
	for(i=0;i<detail.length;i++){
		thumbImg2[i]="../img/buyProductB1_R_thumb"+i+".jpg";
	}
	for(i=0;i<detail.length;i++){
		thumbImg3[i]="../img/buyProductB1_P_thumb"+i+".jpg";
	}
	...
	white.click(function(){
		...
		$("#descTab .desc_table li:eq(3)").text("OWH(오프화이트)");
		$("#descWrap section").hide();
		$("#descTab").show();
		$("#cateTab li a").removeClass("on");
		$("#cateTab li:eq(0) a").addClass("on");
	...
	red.click(function(){
		...
		$("#descTab .desc_table li:eq(3)").text("DRD(다크레드)");
		$("#descWrap section").hide();
		$("#descTab").show();
		$("#cateTab li a").removeClass("on");
		$("#cateTab li:eq(0) a").addClass("on");
	...
	pink.click(function(){
		...
		$("#descTab .desc_table li:eq(3)").text("LPK(라이트핑크)");
		$("#descWrap section").hide();
		$("#descTab").show();
		$("#cateTab li a").removeClass("on");
		$("#cateTab li:eq(0) a").addClass("on");

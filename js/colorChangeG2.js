$(document).ready(function(){
	...
	for(i=0;i<detail.length;i++){
		thumbImg0[i]="../img/buyProductG2_W_thumb"+i+".jpg";
	}
	for(i=0;i<detail.length;i++){
		thumbImg1[i]="../img/buyProductG2_N_thumb"+i+".jpg";
	}
	for(i=0;i<detail.length;i++){
		thumbImg2[i]="../img/buyProductG2_P_thumb"+i+".jpg";
	}
	white.click(function(){
		...
		$("#descTab .desc_table li:eq(3)").text("WWT(화이트)");
	...
	navy.click(function(){
		...
		$("#descTab .desc_table li:eq(3)").text("NNV(네이비)");
		$("#descWrap section").hide();
		$("#descTab").show();
		$("#cateTab li a").removeClass("on");
		$("#cateTab li:eq(0) a").addClass("on");
	...
	pink.click(function(){
		...
		$("#descTab .desc_table li:eq(3)").text("WPK(화이트핑크)");
		$("#descWrap section").hide();
		$("#descTab").show();
		$("#cateTab li a").removeClass("on");
		$("#cateTab li:eq(0) a").addClass("on");

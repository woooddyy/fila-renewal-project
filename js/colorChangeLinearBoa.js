$(document).ready(function(){
	...
	var cream=$("#buy .color li:eq(0) a");
	var red=$("#buy .color li:eq(1) a");
	...
	for(i=0;i<detail.length;i++){
		thumbImg0[i]="../img/buyProductLinearBoa_C_thumb"+i+".jpg";
	}
	for(i=0;i<detail.length;i++){
		thumbImg1[i]="../img/buyProductLinearBoa_R_thumb"+i+".jpg";
	}
	for(i=0;i<detail.length;i++){
		thumbImg2[i]="../img/buyProductLinearBoa_Bk_thumb"+i+".jpg";
	}
	cream.click(function(){
		...
		$("#descTab .desc_table li:eq(3)").text("CRM(크림)");
	...
	red.click(function(){
		...
		$("#descTab .desc_table li:eq(3)").text("RED(레드)");
		$("#descWrap section").hide();
		$("#descTab").show();
		$("#cateTab li a").removeClass("on");
		$("#cateTab li:eq(0) a").addClass("on");

$(document).ready(function(){
	...
	for(i=0;i<detail.length;i++){
		thumbImg0[i]="../img/buyProductM2_B_thumb"+i+".jpg";
	}
	for(i=0;i<detail.length;i++){
		thumbImg1[i]="../img/buyProductM2_W_thumb"+i+".jpg";
	}
	for(i=0;i<detail.length;i++){
		thumbImg2[i]="../img/buyProductM2_Bk_thumb"+i+".jpg";
	}
	...
	white.click(function(){
		...
		$("#descTab .desc_table li:eq(3)").text("WNR(화이트네이비레드)");
		$("#descWrap section").hide();
		$("#descTab").show();
		$("#cateTab li a").removeClass("on");
		$("#cateTab li:eq(0) a").addClass("on");
